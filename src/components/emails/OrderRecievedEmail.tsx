        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We&apos;re preparing everything for delivery and we will notify
              you once your package has been shipped. Delivery usually takes 2
              days
            </Text>
          ...
          <Section style={paddingY}>
            ...
            <Row>
              <Text style={footer.text}>
                &copy; CaseUp, Inc. All Rights Reserved.
              </Text>
            </Row>
          </Section>
        </Container>
